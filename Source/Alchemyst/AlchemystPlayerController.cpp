...
void AAlchemystPlayerController::SetupInputComponent()
{
	...
	InputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AAlchemystPlayerController::MoveToTouchLocation);
	InputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AAlchemystPlayerController::MoveToTouchLocation);

	InputComponent->BindAction("ResetVR", IE_Pressed, this, &AAlchemystPlayerController::OnResetVR);
}

void AAlchemystPlayerController::OnResetVR()
{
...
void AAlchemystPlayerController::MoveToTouchLocation(const ETouchIndex::Type FingerIndex, const FVector Location)
{
